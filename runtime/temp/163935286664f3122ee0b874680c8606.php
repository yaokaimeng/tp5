<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp64\www\tp5\public/../application/index\view\car\car22.html";i:1521812608;}*/ ?>
            ...
            <ul class="hNavList">
                ...
                <li class="Ymykad ">
                    ...
                    <div class="Ytopnavdiv">
                        <dl class="Ymykadc">
                            <dd>
                                <a href="<?php echo url('user/grzl'); ?>">个人中心</a>
                            </dd>
                            <dd>
            ...
            <div class="orderDetails">
                        <div class="pro-list-show">
                            ...
                            <p class="th">
                                ...
                                <div class="kad-pro-intor" style='height:34px;'>
...
1瓶                                    </div>
                            ...
                            <!--赠品-->
                                   <div class="accounts-msg" style='margin-top: -25px;border-bottom: 1px solid #ccc'>
                    您需要为订单共支付<span class="order-total-money" id="TotalMoney">￥<?php echo $val['curprice']; ?></span>
