<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\wamp64\www\tp5\public/../application/index\view\user\xiugai.html";i:1521436729;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<body>
	...
	<form action="<?php echo url('user/add',array('id'=>$find['id'])); ?>" method='post' value=>
                <p class="pl10"> 
