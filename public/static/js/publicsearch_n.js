...
//关键字刷新自动变化
var SearchTxt = new Array('安神','健脾益胃','腹泻','便秘','手足癣','维矿物质','改善睡眠','提高免疫','多种维生素','钙尔奇','痛风', '跌打损伤','鼻炎','汤臣倍健','冬虫夏草','咽喉炎','石斛','枸杞','同仁堂','补气补血','汇仁','高血压'), SearchTxtId = Math.floor(Math.random() * SearchTxt.length), SearchValue = SearchTxt[SearchTxtId];
